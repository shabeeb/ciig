  ...
  <body>
    ...
    <div class="container">
        ...
        <form name="" action="" class="form-signin"  method="post">
            <h2 class="form-signin-heading" >Welcome to CIIgniter!</h2>
            <?php echo validation_errors(); ?>
            <div id="body" class="col-lg-3">
            <label>Table Name</label>  <input type="text" name="tname"  class="form-control" placeholder="Table Name" >
        </div>
	<div id="body" class="col-lg-3">
            <label>Controller Name</label> 
            <input type="text" "  class="form-control" placeholder="Controller Name" name="cname">
        </div>
	<div id="body"  class="col-lg-3">
            <label>Form title</label>  <input type="text" name="fname"  class="form-control"   placeholder="Form title" >
        </div>
            <br />
